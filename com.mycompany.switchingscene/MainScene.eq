...
public class MainScene : SEScene
{
	...
	public void initialize(SEResourceCache rsc) {
		...
		rsc.prepare_image("image1", "molang", get_scene_width()*0.5, get_scene_height()*0.5);
		rsc.prepare_image("image2", "minion", get_scene_width()*0.5, get_scene_height()*0.5);
		rsc.prepare_image("image3", "agnes", get_scene_width()*0.5, get_scene_height()*0.5);
		rsc.prepare_image("image4", "max", get_scene_width()*0.5, get_scene_height()*0.5);
